...
internal sealed class ModuleEnvironment : DeclarativeEnvironment
{
    ...
    /// </summary>
    public void CreateImportBinding(Key importName, Module module, string name)
    {
    ...
    internal override bool TryGetBinding(BindingName name, [NotNullWhen(true)] out JsValue? value)
    {
        ...
        {
            value = indirectBinding.Module._environment.GetBindingValue((Key) indirectBinding.BindingName, strict: true);
            return true;
        }
