...
{
    private static readonly Key propertyAggregateError = (Key) "AggregateError";
    private static readonly Key propertyArray = (Key) "Array";
    private static readonly Key propertyArrayBuffer = (Key) "ArrayBuffer";
    private static readonly Key propertyAtomics = (Key) "Atomics";
    private static readonly Key propertyBigInt = (Key) "BigInt";
    private static readonly Key propertyBigInt64Array = (Key) "BigInt64Array";
    private static readonly Key propertyBigUint64Array = (Key) "BigUint64Array";
    private static readonly Key propertyBoolean = (Key) "Boolean";
    private static readonly Key propertyDataView = (Key) "DataView";
    private static readonly Key propertyDate = (Key) "Date";
    private static readonly Key propertyError = (Key) "Error";
    private static readonly Key propertyEvalError = (Key) "EvalError";
    private static readonly Key propertyFinalizationRegistry = (Key) "FinalizationRegistry";
    private static readonly Key propertyFloat16Array = (Key) "Float16Array";
    private static readonly Key propertyFloat32Array = (Key) "Float32Array";
    private static readonly Key propertyFloat64Array = (Key) "Float64Array";
    private static readonly Key propertyFunction = (Key) "Function";
    private static readonly Key propertyGeneratorFunction = (Key) "Generator";
    private static readonly Key propertyInt16Array = (Key) "Int16Array";
    private static readonly Key propertyInt32Array = (Key) "Int32Array";
    private static readonly Key propertyInt8Array = (Key) "Int8Array";
    //private static readonly Key propertyIntl = "Intl";
    private static readonly Key propertyJSON = (Key) "JSON";
    private static readonly Key propertyMap = (Key) "Map";
    private static readonly Key propertyMath = (Key) "Math";
    private static readonly Key propertyNumber = (Key) "Number";
    private static readonly Key propertyObject = (Key) "Object";
    private static readonly Key propertyPromise = (Key) "Promise";
    private static readonly Key propertyProxy = (Key) "Proxy";
    private static readonly Key propertyRangeError = (Key) "RangeError";
    private static readonly Key propertyReferenceError = (Key) "ReferenceError";
    private static readonly Key propertyReflect = (Key) "Reflect";
    private static readonly Key propertyRegExp = (Key) "RegExp";
    private static readonly Key propertySet = (Key) "Set";
    private static readonly Key propertyShadowRealm = (Key) "ShadowRealm";
    private static readonly Key propertySharedArrayBuffer = (Key) "SharedArrayBuffer";
    private static readonly Key propertyString = (Key) "String";
    private static readonly Key propertySymbol = (Key) "Symbol";
    private static readonly Key propertySyntaxError = (Key) "SyntaxError";
    private static readonly Key propertyTypeError = (Key) "TypeError";
    private static readonly Key propertyTypedArray = (Key) "TypedArray";
    private static readonly Key propertyURIError = (Key) "URIError";
    private static readonly Key propertyUint16Array = (Key) "Uint16Array";
    private static readonly Key propertyUint32Array = (Key) "Uint32Array";
    private static readonly Key propertyUint8Array = (Key) "Uint8Array";
    private static readonly Key propertyUint8ClampedArray = (Key) "Uint8ClampedArray";
    private static readonly Key propertyWeakMap = (Key) "WeakMap";
    private static readonly Key propertyWeakRef = (Key) "WeakRef";
    private static readonly Key propertyWeakSet = (Key) "WeakSet";
    private static readonly Key propertyNaN = (Key) "NaN";
    private static readonly Key propertyInfinity = (Key) "Infinity";
    private static readonly Key propertyUndefined = (Key) "undefined";
    private static readonly Key propertyParseInt = (Key) "parseInt";
    private static readonly Key propertyParseFloat = (Key) "parseFloat";
    private static readonly Key propertyIsNaN = (Key) "isNaN";
    private static readonly Key propertyIsFinite = (Key) "isFinite";
    private static readonly Key propertyDecodeURI = (Key) "decodeURI";
    private static readonly Key propertyDecodeURIComponent = (Key) "decodeURIComponent";
    private static readonly Key propertyEncodeURI = (Key) "encodeURI";
    private static readonly Key propertyEncodeURIComponent = (Key) "encodeURIComponent";
    private static readonly Key propertyEscape = (Key) "escape";
    private static readonly Key propertyUnescape = (Key) "unescape";
    private static readonly Key propertyGlobalThis = (Key) "globalThis";
    private static readonly Key propertyEval = (Key) "eval";
    private static readonly Key propertyToString = (Key) "toString";
